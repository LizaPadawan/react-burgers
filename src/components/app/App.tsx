    ...
    return (
      <>
        ...
        <Routes location={background || location}>
          ...
          <Route
            path="/login"
            element={<ProtectedRoute element={<Login />} onlyUnAuth={true} />}
          />
          <Route
            path="/register"
            element={
              <ProtectedRoute element={<Register />} onlyUnAuth={true} />
            }
          />
          <Route
          ...
          <Route
            path="/reset-password"
            element={
              <ProtectedRoute element={<ResetPassword />} onlyUnAuth={true} />
            }
          />
          <Route
            path="/profile"
            element={
              <ProtectedRoute element={<Profile />} onlyUnAuth={false} />
            }
          />
          <Route
            path="/profile/:orders"
            element={
              <ProtectedRoute element={<ProfileOrders />} onlyUnAuth={false} />
            }
          />
          <Route
            path="/profile/:orders/:orderId"
            element={
              <ProtectedRoute element={<OrderPage />} onlyUnAuth={false} />
            }
          />
